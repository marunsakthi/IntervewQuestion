...
class Home extends Component {
  ...
  render() {
    ...
    return (
      <Container >
        <Popup handleSubmit = {this.handleSubmit} showPopup = {this.state.showPopup} closePopup = {this.closePopup} incomeType= {this.state.incomeType} handleInput= {this.handleInput}/>
        <Balance/>
        <Expenditure expenditure= {expenditure}/>
        <Addbutton popShow= {this.popShow}/>
      </Container>
    );
  }
}
